...
import ApexBar from "../charts/apexcharts/Bar";
import ApexBar2 from "../charts/apexcharts/Bar2";

/// Scroll
import PerfectScrollbar from "react-perfect-scrollbar";

const Ext = React.lazy(() => import("../../layouts/Ext"));
const DistanceMap = () => {
         ...
         <div className="row">
            ...
            <div className="col-xl-3 col-xxl-4 col-lg-4">
               <div className="card">
                  ...
                  <PerfectScrollbar className="card-body dz-scroll height370 ps ps--active-y">
