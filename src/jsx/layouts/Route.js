...
import AddCourseSessionType from "../components/Master/CourseSessionType/AddCourseSessionType";
...
const Routes = () => {
  const routes = [
    ...
    { url: "master-add-Course-Session-Type", component: AddCourseSessionType },
